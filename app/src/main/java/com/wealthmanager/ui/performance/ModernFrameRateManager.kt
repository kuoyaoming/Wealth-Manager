...
class ModernFrameRateManager
    ...
    constructor(
         ...
         */
        fun setOptimalFrameRate(
            activity: Activity,
            frameRate: Float = FRAME_RATE_120,
        ) {
            try {
         ...
         */
        private fun setLegacyFrameRate(
            activity: Activity,
            frameRate: Float,
        ) {
            try {
