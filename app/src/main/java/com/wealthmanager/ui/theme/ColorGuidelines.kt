...
object ColorGuidelines {
    ...
    @Composable
    private fun getPositiveColor(): Color = MaterialTheme.colorScheme.primary

    @Composable
    private fun getNegativeColor(): Color = MaterialTheme.colorScheme.error

    @Composable
    private fun getNeutralColor(): Color = MaterialTheme.colorScheme.onSurfaceVariant

    @Composable
    private fun getWarningColor(): Color = MaterialTheme.colorScheme.tertiary

    @Composable
    private fun getInfoColor(): Color = MaterialTheme.colorScheme.secondary
}
