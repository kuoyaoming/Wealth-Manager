...
object MoneyFormatter {
    ...
    private val defaultFractionDigits: Map<String, Int> =
        mapOf(
            "TWD" to 0,
            "USD" to 2,
        )

    private val contextOverrides: Map<MoneyContext, Map<String, Int>> =
        mapOf(
            MoneyContext.CashAmount to
                mapOf(
                    "TWD" to 0,
                    "USD" to 2,
                ),
            MoneyContext.StockPrice to
                mapOf(
                    "TWD" to 2,
                    "USD" to 2,
                ),
            MoneyContext.Total to
                mapOf(
                    "TWD" to 0,
                ),
            MoneyContext.ChartLabel to
                mapOf(
                    "TWD" to 0,
                ),
        )
