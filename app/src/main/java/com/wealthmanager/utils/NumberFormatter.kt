...
class NumberFormatter
    ...
    constructor() {
         ...
         */
        fun formatUsdPrice(price: Double): String = USD_FORMAT.format(price)

        /**
         * Format TWD price (integer)
         */
        fun formatTwdPrice(price: Double): String = TWD_FORMAT.format(price.toInt())

        /**
         * Format shares (two decimal places)
         */
        fun formatShares(shares: Double): String = SHARES_FORMAT.format(shares)

        /**
         * Format price by currency
         */
        fun formatPriceByCurrency(
            price: Double,
            currency: String,
        ): String {
