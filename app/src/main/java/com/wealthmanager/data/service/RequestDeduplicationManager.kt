...
class RequestDeduplicationManager
    ...
    constructor(
            ...
            return requestMutex.withLock {
                ...
                if (existingRequest != null) {
                    ...
                    if (timeSinceStart < DEDUPLICATION_WINDOW_MS) {
                        debugLogManager.log(
                            "REQUEST_DEDUP",
                            "Duplicate request intercepted: $requestKey (in progress: ${timeSinceStart}ms)",
                        )
                ...
                if (concurrentRequestCount >= MAX_CONCURRENT_REQUESTS) {
                    debugLogManager.logWarning(
                        "REQUEST_DEDUP",
                        "Reached maximum concurrent request limit: $concurrentRequestCount",
                    )
        ...
        suspend fun cleanupExpiredRequests() {
            ...
            val expiredRequests =
                ongoingRequests.filter { (_, request) ->
