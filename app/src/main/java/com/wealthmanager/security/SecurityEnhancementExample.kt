 ...
 */
@Singleton
class SecurityEnhancementExample @Inject constructor(
    ...
    suspend fun setFinnhubKeyExample(
        ...
        secureApiKeyManager.setApiKeySecurely(
            ...
            onSuccess = { validationResult ->
                debugLogManager.log("SECURITY_EXAMPLE", "Finnhub key set successfully with strength: ${validationResult.strength}")
                onSuccess()
            },
            onError = { error ->
